...
#ANTIJS_V2
#cl = LineClient
cl = LineClient(authToken='EEaaqoohXd0J6wQ9B5j3.wuylwj4ToT26kXh9NU8+8W.GYdd6Nfo/Ac2eMzLtIF20fdvrtQtK3VG58wU1OAUDXk=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

#ki = LineClient()
ki = LineClient(authToken='ED4S5eyTvEAUuimKBZGd.cBqPBIPiNBYH4aWnNZR4Rq.0pq58KfXrjQq3vD2r5kz6w0qT9D8HCgO9C+2UpljJnI=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

#kk = LineClient()
kk = LineClient(authToken='ED0jXqC4lT2N7dJCZuBc.4KIdIZKSYSOS6SooAeL7ta.vvLZY8i5LOF1GEGiZTAZ2AsWrrzLT31cOYwRv9jjaBs=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

#kc = LineClient()
kc = LineClient(authToken='EDEa2Bi3zub161Wop3N8.BpCKkf3Ju3l/twO2UzdtYa.g/NsqAvFaK3U09iJhZeHXPacMlMSqPu/bqYIMaHDqBQ=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

#sw = LineClient()
sw = LineClient(authToken='ED4aVeBGLXH486dwiZu9.0Plp4Ym3n/hwIW3dz0Mf/q.wirookNHjDmMwOmaSrl1kNB67Fq4toWaQ22jYvCK/9k=')
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,Hadir Semua Boss)
...
#===========KICKOUT============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                             ...
                             cl.sendMessage(receiver,"BYEEE")
                             targets = []
                             for g in gs.members:
                                 if _name in g.displayName:
                                     targets.append(g.mid)
                             if targets == []:
                                 cl.sendMessage(receiver,"Not found.")
                             else:
                                 for target in targets:
                                    if not target in Bots or target in admin:
                                         try:
                                           random.choice(ABC).kickoutFromGroup(msg.to, [target])
                                         except:
                                             cl.sendMessage(receiver,"Group bersih")
